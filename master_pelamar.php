...
<div class="row no-gutters">
  ...
  <li class="nav-item">
    ...
    <div class="col-md-9 p-5 pt-2">
        <h3><i class="fa-sharp fa-solid fa-user" style="color: #000000;"></i>Input Data Pelamar</h3>
        <div class="row">
        <div class="col-md-12">
    ...
    <div class="form-group">
        <label for="exampleInputEmail1">Status Menikah</label>
        <input type="number" class="form-control">
    </div>
    <div class="form-group">
        <label for="exampleInputEmail1">Surat Lamaran</label>
        <input type="text" class="form-control">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="exampleInputEmail1">SKCK</label>
        <input type="text" class="form-control">
    </div>
    <div class="form-group">
        <label for="exampleInputEmail1">Surat Kesehatan</label>
        <input type="text" class="form-control">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="exampleInputEmail1">Tanggal Melamar</label>
        <input type="text" class="form-control">
    </div>
